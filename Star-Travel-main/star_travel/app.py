...
def searchCall():
    ...
    dpg.set_value('txtPath', bestPath[0])
    dpg.set_value('txtCost', bestPath[1])
...
with dpg.window(label='Probando...',width=900,height=450):
    ...
    dpg.add_text('La trayectoria optima es:',color=[223,0,0])
    dpg.add_text('',color=[223,0,0],tag='txtPath')
    dpg.add_text('El costo total es :',color=[223,0,0])
    dpg.add_text('',color=[223,0,0],tag='txtCost')
