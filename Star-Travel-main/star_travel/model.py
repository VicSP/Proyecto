...
def aStarSearch(initLocation): # Función que inicia la Busqueda utilizando el algoritmo A*
                               # Recibe la posición inicial de donde se hará la busqueda 
    if (initLocation in locations):
        goalLocation = "Bucharest" # Ciudad meta
        ...
        while(len(openList) > 0):
            ...
            for lowerFLocation in openList:
                if (location == None or (gDistance[lowerFLocation] + straightLineDistances[lowerFLocation] 
                                             < gDistance[location] + straightLineDistances[location])):
        ...
        print("La ciudad inicial no es correcta, vuelva a introducirla :(")
